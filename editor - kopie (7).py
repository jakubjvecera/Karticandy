...
class SVGEditor(TkinterDnD.Tk):
    ...
    def save_svg(self):
        ...
        try:
            ...
            # Po uložení PNG odstraníme a přepneme na další SVG
            self.original_img = None
            if hasattr(self, "canvas_image_id"):
                self.canvas.delete(self.canvas_image_id)
